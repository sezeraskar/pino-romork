...
import { getProjeGelistirme, getSite, waFor } from "@/lib/data";
...
export default async function ProjeGelistirmePage() {
  const [projeGelistirme, site] = await Promise.all([getProjeGelistirme(), getSite()]);
      ...
      <section className="page-hero">
        <div className="wrap">
          ...
          <Reveal className="cat-hero-cta">
            <a href={waFor(site.whatsappPhone, "Proje Geliştirme")} className="btn" target="_blank" rel="noopener noreferrer">
              Projenizi anlatın
              <ArrowRight />
            </a>
