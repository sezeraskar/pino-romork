...
import { getCekiDemiri, getSite, waFor } from "@/lib/data";
...
export default async function CekiDemiriPage() {
  const [cekiDemiri, site] = await Promise.all([getCekiDemiri(), getSite()]);
      ...
      <section className="page-hero">
        <div className="wrap">
          ...
          <Reveal className="cat-hero-cta">
            <a href={waFor(site.whatsappPhone, "Çeki Demiri")} className="btn" target="_blank" rel="noopener noreferrer">
              Teklif alın
              <ArrowRight />
            </a>
